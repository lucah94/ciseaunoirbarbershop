...
const CONTENT_PROMPTS: Record<string, string> = {
  promotion: `Génère une publication Facebook promotionnelle pour Ciseau Noir Barbershop à Québec. Mentionne une offre spéciale, un service ou incite à réserver en ligne sur ciseunoirbarbershop.com. Utilise des emojis appropriés. 2-4 phrases max. En français.`,
