...
const CONTENT_PROMPTS: Record<string, string> = {
  ...
  service: `Génère une publication Facebook qui met en avant un service de Ciseau Noir Barbershop. Choisis parmi : Coupe adulte (35$), Coupe + Barbe (45$), Coupe enfant (25$), Barbe (20$), Coupe + Lavage (35$). Décris le service avec enthousiasme. Mentionne la barbière Melynda. Utilise des emojis. 3-4 phrases. En français.`,
